...
public class EnemyAI : MonoBehaviour {
    ...
    private AttributeManager2 attributeManager;
    ...
    void Start() {
        ...
        attributeManager = GetComponent<AttributeManager2>();
    }
    ...
    private void Die() {
        if (attributeManager.GetAttributes().Loot != null && !isDead) {
            Instantiate(attributeManager.GetAttributes().Loot, transform.position, transform.rotation);
            isDead = true;
        }
