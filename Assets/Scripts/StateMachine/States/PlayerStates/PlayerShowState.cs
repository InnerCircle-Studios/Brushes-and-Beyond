...
public class PlayerShowState : State {
    ...
    public override void EnterState() {
        ...
        _PlayerStateMachine.GetActor().GetGameManager().GetWindowManager().InitDialogueBox(_PlayerStateMachine.GetActor());
        _PlayerStateMachine.GetActor().GetGameManager().GetWindowManager().UpdateDialogueBox("Test string. Blood for the blood god! Skulls for the skull throne!");
    }
